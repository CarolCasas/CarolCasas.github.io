<?php
    ...
    if($calificacion >= 0 && $calificacion <=5){
        echo "<h3> Calificación: ".$calificacion." <br> No aprovado (Informate bebé)</h3>";
        echo "<img src='Malilla.png' width'10%'<hr>";
    }else if($calificacion >=6 && $calificacion <=8){
        echo "<h3> Calificación: ".$calificacion." <br> Ahí la llevas (Tu puedes chikite)</h3>";
        echo "<img src='pensando.png' width'10%'<hr>";
    }else if($calificacion >=9 && $calificacion <=10){
        echo "<h3> Calificación: ".$calificacion." <br> Me impresionas (Que orgullo)</h3>";
